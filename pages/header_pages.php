...
<!--             <div class="header_burger">
            ...
            <nav class="header_menu">
                <ul class="header_list">
                    <li><a href='studios.php' class="header_link">Студии</a></li>
                    <li><a href='services.php' class="header_link">Услуги</a></li>
                    
                    <?php 
                        if (is_user_logged_in()){ 
                            ?>
                                <li><a href='my-orders.php' class="header_link">Мои заказы</a></li>
                            <?php
                            $m = get_user_info(get_current_user_id());
                            if ($m['post_id']!=1){
                            ?>
                            <li><a href='admin.php' class="header_link">Управление</a></li>
                            <?php
                            }
                        ?>
                        <input type='button' value='Выйти' onclick="exit()" style="margin-left: 15px;">
                    <?php } else {?>
                        <li><a href='auth.php' class="header_link">Авторизация</a></li>
                    <?php } ?>
                    </li>
                </ul>
            </nav>
